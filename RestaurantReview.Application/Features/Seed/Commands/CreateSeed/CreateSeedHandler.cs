...
namespace RestaurantReview.Application.Features.Seed.Commands.CreateSeed
{
    public class CreateSeedHandler : ICreateSeedService
    {
        ...
        public async Task<string> CreateSeed()
        {
            ...
            var BommenRestaurang = new Restaurant { TempImage = "https://lh3.googleusercontent.com/proxy/aEvbPzW-s4ohbrOAdcbnNoW17Vyx-IYQe21qAHv2Cn2X_il-4DWzfSfLP-solsblnZPVbH5jpURac_a1UuI-o_p1Dkmehnkxnbw7jWVg4DtHetuWGnikjg6LYmW9JA", RestaurantID = new Guid(), RestaurantName = "Bommen Restaurang & Bar", RestaurantLink = "http://www.bommen.nu/", MapURL = "https://satellites.pro/plan/Sweden_map#57.709578,11.964380,17", Description = "The restaurant is perfect for you who are going to visit the Gothenburg Opera and just as cozy for you who want a nice evening on the town." };
